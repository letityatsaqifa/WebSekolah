                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-inline user-name"><?php echo $_SESSION['nama']; ?></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <li class="user-header text-bg-primary">
                                ...
                                <p>
                                    ...
                                    <small class="user-role">Role: <?php echo $_SESSION['role']; ?></small>
                                </p>
                            </li>
                        ...
                        <div class="col-12">
                            <div class="profile-card">
                                <div class="profile-header">
                                    ...
                                    <div class="profile-name user-name"><?php echo $_SESSION['nama']; ?></div>
                                    <small class="profile-role user-role">Role: <?php echo $_SESSION['role']; ?></small>
                                </div>
