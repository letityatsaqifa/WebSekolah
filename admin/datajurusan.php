          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body p-0 table-responsive">
                    <table id="myTable" class="display nowrap" style="width:100%">
                      <thead>
                        <tr>
                          <th style="width: 50px">Id Jurusan</th>
                          <th>Nama Jurusan</th>
                      ...
                      <tbody>
                        <?php
                          ...
                          <tr>
                              ...
                              <td class="op">
                                <button type="button" class="btn btn-warning btn-sm btn-edit" data-id="<?php echo $x['kodejurusan']; ?>" data-bs-toggle="modal" data-bs-target="#editModal">
                                    <i class="bi bi-pencil-square"></i> Edit
                                </button>
                                
                                <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?php echo $x['kodejurusan']; ?>">
                ...
                <!-- /.card -->
                <a href="tambahjurusan.php" class="add-button">Tambah Data</a>
              </div>
              <!-- /.col -->
            </div>
            <!--end::Row-->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="editForm">
                <input type="hidden" id="edit_kodejurusan" name="kodejurusan">
                <div class="mb-3">
                  <label for="edit_namajurusan" class="form-label">Nama Jurusan</label>
                  <input type="text" class="form-control" id="edit_namajurusan" name="namajurusan" required>
                </div>
              </form>
            </div>
      ...
      $(document).ready(function() {
          ...
          $('#myTable tbody').on('click', '.btn-edit', function() {
              ...
              $.ajax({
                  url: 'api_jurusan.php',
                  type: 'GET',
                  data: { aksi: 'get_single', kodejurusan: id },
                  dataType: 'json',
                  success: function(response) {
                      if(response.status === 'success') {
                          $('#edit_kodejurusan').val(response.data.kodejurusan);
                          $('#edit_namajurusan').val(response.data.namajurusan);
                      } else {
              ...
              Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      $.ajax({
                          url: 'api_jurusan.php',
                          type: 'POST',
                          data: { aksi: 'hapus', kodejurusan: id },
                          dataType: 'json',
                          success: function(response) {
                              if (response.status === 'success') {
