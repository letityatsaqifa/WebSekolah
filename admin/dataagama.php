  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body p-0 table-responsive">
                    <table id="myTable" class="display nowrap" style="width:100%">
                      <thead>
                        <tr>
                          <th style="width: 50px">Id Agama</th>
                          <th>Nama Agama</th>
                      ...
                      <tbody>
                        <?php
                          ...
                          <tr>
                              ...
                              <td class="op">
                                  <button type="button" class="btn btn-warning btn-sm btn-edit" data-id="<?php echo $x['idagama']; ?>" data-bs-toggle="modal" data-bs-target="#editModal">
                                      <i class="bi bi-pencil-square"></i> Edit
                                  </button>
                                  
                                  <button type="button" class="btn btn-danger btn-sm btn-hapus" data-id="<?php echo $x['idagama']; ?>">
                ...
                <!-- /.card -->
                <a href="tambahagama.php" class="add-button">Tambah Data</a>
              </div>
              <!-- /.col -->
            </div>
            <!--end::Row-->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="editForm">
                <input type="hidden" id="edit_idagama" name="idagama">
                <div class="mb-3">
                  <label for="edit_namaagama" class="form-label">Nama Agama</label>
                  <input type="text" class="form-control" id="edit_namaagama" name="namaagama" required>
                </div>
              </form>
            </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script> <script>
      $(document).ready(function() {
          ...
          // SCRIPT UNTUK FUNGSI EDIT
          $('#myTable tbody').on('click', '.btn-edit', function() {
              var id = $(this).data('id');
              $.ajax({
                  url: 'api_agama.php',
                  type: 'GET',
                  data: { aksi: 'get_single', idagama: id },
                  dataType: 'json',
                  success: function(response) {
                      if(response.status === 'success') {
                          $('#edit_idagama').val(response.data.idagama);
                          $('#edit_namaagama').val(response.data.namaagama);
                      } else {
          ...
          $('#saveEditButton').on('click', function() {
              $.ajax({
                  url: 'api_agama.php',
                  type: 'POST',
                  data: $('#editForm').serialize() + '&aksi=update',
                  dataType: 'json',
                  success: function(response) {
                      if(response.status === 'success') {
